...
export default function NDISIntro() {
  return (
    <section className="who-we-are ndis-intro">
      <div className="who-we-are-edge-top" aria-hidden="true" />

      <div className="who-we-are-inner container">
        <div className="who-we-are-copy">
          <span className="section-label">NDIS OVERVIEW</span>
          <h2 className="who-we-are-title">Support centred around your goals.</h2>
          <p>
