...
export default function NDISSupportAreas() {
  return (
    <section className="about-values ndis-areas">
      <div className="about-values-heading-decor" aria-hidden="true" />
      <div className="about-values-inner container">
        <span className="section-label section-label--center">SUPPORT AREAS</span>
        <h2 className="about-values-heading">How we may support you.</h2>
        ...
        <div className="ndis-areas-grid">
          {areas.map(({ label, Icon }) => (
            <article className="ndis-area-item" key={label}>
              <div className="service-icon ndis-area-icon" aria-hidden="true">
                <Icon />
              </div>
